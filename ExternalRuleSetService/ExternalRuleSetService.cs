...
{
    public class ExternalRuleSetService 
    {
        ...
        public RuleSet GetRuleSet(RuleSetInfo ruleSetInfo)
        {
            if (ruleSetInfo != null)
            {
                ...
                command.Parameters.Add("@MajorVersion", System.Data.SqlDbType.Int);
                command.Parameters.Add("@MinorVersion", System.Data.SqlDbType.Int);
                command.Parameters["@Name"].Value = ruleSetInfo.Name;
                command.Parameters["@MajorVersion"].Value = ruleSetInfo.MajorVersion;
                command.Parameters["@MinorVersion"].Value = ruleSetInfo.MinorVersion;
                ...
                if (reader.HasRows)
                {
                    ...
                    try
                    {
                        ...
                        data.AssemblyPath = ConfigurationManager.AppSettings["RulesPath"].ToString();
