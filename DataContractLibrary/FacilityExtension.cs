...
namespace DataContractLibrary
{
    ...
    public class FacilityExtension : IInstanceContextProvider, IDispatchMessageInspector
    {
    ...
    // This class lives in a table in FacilityExtension, and allows different threads to
    ...
    public class AddressableInstanceContextInfo : IExtension<InstanceContext>, IExtension<IContextChannel>
    {
        ...
        readonly FacilityExtension parent;
        ...
        internal AddressableInstanceContextInfo(FacilityExtension parent, string id)
        {
            this.parent = parent;
