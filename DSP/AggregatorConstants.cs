...
namespace DSP
{
    public class AggregatorConstants
    {
        ...
        public static string AccountHoldingSvcResponse = "AccountHoldingSvcResponse";
        public static string AccountTransferSvcResponse = "AccountTransferSvcResponse";
        public static string ExtraSvcResponse = "ExtraSvcResponse";
